...
class MainActivityEspressoTest {
    ...
    fun forgotPasswordTextView_HasText() {
        val assertion = ViewAssertions.matches(ViewMatchers.withText(FORGOT_PASSWORD_TEXT))
    ...
    fun signUpTextView_HasText() {
        val assertion = ViewAssertions.matches(ViewMatchers.withText(SIGN_UP_TEXT))
    ...
    fun buttonSignIn_hasText() {
        Espresso.onView(withId(R.id.sign_in_button))
            .check(ViewAssertions.matches(ViewMatchers.withText(SIGN_IN_TEXT)))
    }
